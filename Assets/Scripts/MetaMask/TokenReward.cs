...
public class TokenReward : MonoBehaviour
{
    async public void signTokenReward(float _finalScore)
    {
        ...
        // address of contract
        string contract = "0x47222056Af44284b5eE87D153aFA6788B1632B41";

        string[] obj = { amount, playerAccount };
