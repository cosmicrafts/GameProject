...
public class AudioSpectrumsManager : MonoBehaviour
{
	...
	/// </summary>
	[Range(0,500)]
	public int spectrumsNumber = 100;
	
	/// <summary>
	/// The width of the specturm.
	/// </summary>
	[Range(0,1)]
	public float specturmWidth = 0.02f;
	...
	/// </summary>
	[Range(-10,10)]
	public float specturmHeightFactor = 6;
	...
	void Update ()
	{
		...
		for (int i= 0; i< spectrums.Length; i++) {
			...
			spectrums [i].localScale = new  Vector3 (specturmWidth, specturmHeightFactorSign * Mathf.Clamp (specturmHeightFactorAbs * samples [i],spectrumMinHeight, Mathf.Infinity), 1);//0.02f is the minimum scale of the spectrum
		}
	}	
}