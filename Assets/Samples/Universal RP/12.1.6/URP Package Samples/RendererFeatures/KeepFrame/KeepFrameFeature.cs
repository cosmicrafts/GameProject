...
public class KeepFrameFeature : ScriptableRendererFeature
{
    ...
    class DrawOldFramePass : ScriptableRenderPass
    {
        ...
        public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
        {
            ...
            if (m_handle == null)
            {
                m_handle = RTHandles.Alloc(descriptor.width, descriptor.height, depthBufferBits: 0, colorFormat: ConvertRenderTextureFormat(descriptor.colorFormat), dimension: TextureDimension.Tex2D, useDynamicScale: true, name: "_OldFrameRenderTarget");
            }
        }

        private static GraphicsFormat ConvertRenderTextureFormat(RenderTextureFormat format)
        {
            return GraphicsFormatUtility.GetGraphicsFormat(format, RenderTextureReadWrite.Default);
        }
