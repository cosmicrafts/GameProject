...
namespace Quantum.Prototypes.Unity {
  ...
  [Quantum.Prototypes.PrototypeAttribute(typeof(Quantum.Gameplay))]
  public class Gameplay_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.Gameplay_Prototype> {
    [Quantum.Inspector.HideInInspectorAttribute()]
    public System.Byte AlphaScore;
    [Quantum.Inspector.HideInInspectorAttribute()]
    public System.Byte BetaScore;
    [Quantum.LocalReference]
    public global::EntityPrototype AlphaCastle;
    [Quantum.LocalReference]
    public global::EntityPrototype BetaCastle;
    [Quantum.Core.FreeOnComponentRemovedAttribute()]
    [Quantum.Inspector.DynamicCollectionAttribute()]
    [Quantum.LocalReference]
    public global::EntityPrototype[] AlphaTowers = System.Array.Empty<global::EntityPrototype>();
    [Quantum.Core.FreeOnComponentRemovedAttribute()]
    [Quantum.Inspector.DynamicCollectionAttribute()]
    [Quantum.LocalReference]
    public global::EntityPrototype[] BetaTowers = System.Array.Empty<global::EntityPrototype>();
    public PlayerArea_Prototype AlphaArea;
    public PlayerArea_Prototype BetaArea;

    public sealed override Quantum.Prototypes.Gameplay_Prototype Convert(EntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.Gameplay_Prototype();
      result.AlphaScore = this.AlphaScore;
      result.BetaScore = this.BetaScore;
      converter.Convert(this.AlphaCastle, out result.AlphaCastle);
      converter.Convert(this.BetaCastle, out result.BetaCastle);
      result.AlphaTowers = System.Array.ConvertAll(this.AlphaTowers, x => { converter.Convert(x, out Quantum.MapEntityId tmp); return tmp; });
      result.BetaTowers = System.Array.ConvertAll(this.BetaTowers, x => { converter.Convert(x, out Quantum.MapEntityId tmp); return tmp; });
      result.AlphaArea = this.AlphaArea.Convert(converter);
      result.BetaArea = this.BetaArea.Convert(converter);
      return result;
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.PrototypeAttribute(typeof(Quantum.PlayerArea))]
  public class PlayerArea_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.PlayerArea_Prototype> {
    public System.SByte MinX;
    public System.SByte MaxX;
    public System.SByte MinY;
    public System.SByte MaxY;
    [Quantum.Core.FreeOnComponentRemovedAttribute()]
    [Quantum.Inspector.DynamicCollectionAttribute()]
    public BlockedArea_Prototype[] BlockedAreas = System.Array.Empty<BlockedArea_Prototype>();

    public sealed override Quantum.Prototypes.PlayerArea_Prototype Convert(EntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.PlayerArea_Prototype();
      result.MinX = this.MinX;
      result.MaxX = this.MaxX;
      result.MinY = this.MinY;
      result.MaxY = this.MaxY;
      result.BlockedAreas = System.Array.ConvertAll(this.BlockedAreas, x => x.Convert(converter));
      return result;
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.PrototypeAttribute(typeof(Quantum.BlockedArea))]
  public class BlockedArea_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.BlockedArea_Prototype> {
    [Quantum.LocalReference]
    ...
    public System.SByte MinY;
    public System.SByte MaxY;
    public Quantum.QBoolean Enabled;

    public sealed override Quantum.Prototypes.BlockedArea_Prototype Convert(EntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.BlockedArea_Prototype();
