...
namespace Photon.Chat
{
    ...
    public class ChatParameterCode
    {
        ...
        /// <summary>(25) Expected properties of channel (CAS).</summary>
        public const byte ExpectedProperties = 25;
        ...
        /// <summary>(26) The operation will be broadcasted to all clients.</summary>
